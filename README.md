...
| Comfortable reading on Mac | A consistent charcoal and lavender interface, larger system-font conversation text, bounded reading width, and quieter activity cards. The prompt footer keeps Attach and More close at hand; expand Terminal keys when needed. Appearance follows the app text-size preference. No server update is needed. |
