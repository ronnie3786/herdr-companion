...
The project license applies to Herdr companion source. Included third-party
materials retain their own licenses and copyright notices.

- Inter fonts: SIL Open Font License 1.1. The complete notice is retained in
  each native app's `Fonts/Inter-LICENSE-OFL.txt`.
- Pierre Diffs: Apache License 2.0. See
  `frontend/herdr-web/public/THIRD_PARTY_NOTICES.md` and
