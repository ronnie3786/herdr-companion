...
/// Stable raw values are persisted locally; changing a display label is safe.
enum ChatTabColor: String, CaseIterable, Codable, Hashable, Identifiable, Sendable {
    ...
    func rowBackground(selected: Bool = false) -> Color {
        blended(over: 0x191A23, amount: selected ? 0.20 : 0.16)
    }
