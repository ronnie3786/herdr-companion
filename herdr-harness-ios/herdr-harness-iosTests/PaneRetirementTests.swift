...
struct PaneRetirementTests {
    ...
    @MainActor
    @Test("The empty-folder view renders with Dynamic Type", arguments: [DynamicTypeSize.large, .accessibility1])
    func emptyFolderRendering(size: DynamicTypeSize) throws {
