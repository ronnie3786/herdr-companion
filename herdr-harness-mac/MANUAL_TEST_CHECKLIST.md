...
The color editor and sidebar filtering below use only this Mac and need no server
update. The optional companion sharing and CLI discovery checks at the end require
a companion advertising `chat-tab-colors-v1` and the matching installed CLIs; the
