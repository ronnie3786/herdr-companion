    ...
    static let workInbox = WorkInboxResponse(
        ...
        reviewRequests: WorkInboxProviderSection(
            ...
            items: [
                GitHubReviewRequest(
                    number: 1,
                    title: "Add a fictional seed catalog",
                ...
                GitHubReviewRequest(
                    number: 2,
                    title: "Export the sample reading list",
                    url: "https://github.com/example-org/reading-journal/pull/2",
                    isDraft: false,
                    state: "open",
                    author: "contributor-b",
                    repository: "example-org/reading-journal"
                ),
            ],
            error: nil
        ),
        jiraTickets: WorkInboxProviderSection(
            ...
            items: jiraTickets.tickets + [
                JiraTicket(
                    key: "APP-103",
                    projectKey: "APP",
                    title: "Review the example postcard colors",
                    status: "In Code Review",
                    priority: "Medium",
                    issueType: "Story",
                    url: "https://example.atlassian.net/browse/APP-103"
                )
            ],
            error: nil
        )
