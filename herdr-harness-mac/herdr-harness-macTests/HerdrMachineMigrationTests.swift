...
struct HerdrMachineMigrationTests {
    ...
    func legacyMigration() throws {
        ...
        let first = HerdrAppModel(credentials: credentials, arguments: [], userDefaults: defaults, configuredMachines: [])
        ...
        let second = HerdrAppModel(credentials: credentials, arguments: [], userDefaults: defaults, configuredMachines: [])
    ...
    func freshMigration() {
        ...
        let model = HerdrAppModel(credentials: credentials, arguments: [], userDefaults: defaults, configuredMachines: [])
