...
ENVIRONMENT_FIELDS = {
    ...
    "first_mate": {
        ...
        "coordinator_thinking": "HERDR_FIRST_MATE_COORDINATOR_THINKING",
        "worker_model": "HERDR_FIRST_MATE_WORKER_MODEL",
    ...
    "code_factory": {
        ...
        "reviser_session_timeout_seconds": "HERDR_CODE_FACTORY_REVISER_SESSION_TIMEOUT_SECONDS",
        "max_rebase_attempts": "HERDR_CODE_FACTORY_MAX_REBASE_ATTEMPTS",
        "max_transient_retries": "HERDR_CODE_FACTORY_MAX_TRANSIENT_RETRIES",
