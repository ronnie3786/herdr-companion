# Herdr Companion 0.40.0 Preview 1
...
This release retains Agent Profiles and First Mate stability/recovery from the preceding previews.

## Companion 0.40.0b1 — separate update
...
4. With companion 0.40.0b1 installed, refresh after a new commit. Confirm the review stays usable and older question bubbles identify their earlier revision. Ask for more detail to override the short-answer default.
